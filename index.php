		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel panel-heading" style="background-color: black; color: white;">SCAP</div>
					<div class="panel panel-body">
						<p>
							<img src="img/scap.png"  width="100%">
						</p>
						<form id="frmLogin">
							<label>Email</label>
    					...
    					.btn-black {
							...
							<span class="btn btn-black btn-sm" id="entrarSistema">Entrar</span>
							<?php if(!$validar): ?>
