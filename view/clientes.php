			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmClientes">
						...
						<span class="btn btn-black" id="btnAdicionarCliente">Salvar</span>
					</form>
				</div>
				<div class="col-sm-8">
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					...
					<style>
						...
						<button id="btnAdicionarClienteU" type="button" class="btn btn-black" data-dismiss="modal">Atualizar</button>
